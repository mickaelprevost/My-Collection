...
class CategoryController extends AbstractController
{
     ...
     * @Route("/{id<\d+>}", name="app_back_category_show", methods={"GET"})
     */
    ...
    /**
     * Modify a cetegory
     * @Route("/edit/{id<\d+>}", name="app_back_category_edit", methods={"GET", "POST"})
     */
    ...
    /**
     * Remove a category
     * @Route("/remove/{id<\d+>}", name="app_back_category_delete", methods={"POST"})
     */
